    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cart', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='deltago.Cart')),
            ],
        ),
        migrations.CreateModel(
            name='Commodity',
            fields=[
                ...
                ('volume_size', models.CharField(blank=True, max_length=128, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_method', models.CharField(blank=True, default=None, max_length=128, null=True)),
                ('ship_address', models.CharField(blank=True, default=None, max_length=200, null=True)),
                ('exchange_rate', models.IntegerField(blank=True, default=500, null=True)),
                ('subtotal', models.IntegerField()),
                ('total', models.IntegerField()),
                ('unpaind_time', models.DateTimeField(default=django.utils.timezone.now)),
                ('archived_time', models.DateTimeField(blank=True, null=True)),
                ('processing_time', models.DateTimeField(blank=True, null=True)),
                ('canceling_time', models.DateTimeField(blank=True, null=True)),
        ...
        migrations.AddField(
            model_name='cart',
            name='commodities',
            field=models.ManyToManyField(through='deltago.Cartship', to='deltago.Commodity'),
        ),
        migrations.AddField(
            model_name='cart',
            name='user',
